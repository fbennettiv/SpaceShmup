...
public class Parallax : MonoBehaviour
{
    ...
    [Tooltip("Controls how much panels react to playermovement(Default 0.25)")]
    ...
    {
        float tY, tX = 0;
        tY = Time.time * scrollSpeed % panelHt + (panelHt
       * 0.5f);
        ...
        if (tY >= 0)
        {
            panels[1].position = new Vector3(tX, tY - panelHt,
           depth);
        }
        else
        {
